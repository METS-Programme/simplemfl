"""
Django settings for simplemfl project.
...
SECRET_KEY = 'XXXX_PLACEHOLDER_XXXX'
...
WSGI_APPLICATION = 'simplemfl.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,
    'URL_FIELD_NAME': 'href', # rename URL field to comply with facility registry API
}
